...
- Pricing: Model Router charges for input tokens routed through the service (currently USD $0.14 per million input tokens) **plus** the consumption of the selected underlying models. Monitor both components in Microsoft Foundry (Operate > Assets > Models > model-router > Monitor).
